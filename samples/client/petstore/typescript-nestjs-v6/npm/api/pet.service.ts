...
export class PetService {
     ...
     */
    public addPet(body: Pet, ): Observable<any>;
    public addPet(body: Pet, ): Observable<AxiosResponse<any>>;
    public addPet(body: Pet, ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findPetsByStatus(status: Array<'available' | 'pending' | 'sold'>, ): Observable<Array<Pet>>;
    ...
    public updatePet(body: Pet, ): Observable<AxiosResponse<any>>;
    public updatePet(body: Pet, ): Observable<any> {

...
public class TypeScriptNestjsClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptNestjsClientCodegen() {
        ...
        this.cliOptions.add(new CliOption(NPM_NAME, "The name under which you want to publish generated npm package."
                + " Required to generate a full nestjs package"));
        ...
        this.cliOptions.add(new CliOption(NEST_VERSION, "The version of Nestjs. Default is '6.5'"));
    }
    ...
    private void addNpmPackageGeneration(SemVer nestVersion) {
        ...
        // nestjs opinationed libs
        supportingFiles.add(new SupportingFile("nest-cli.mustache", getIndexDirectory(), "nest-cli.json"));
        supportingFiles.add(new SupportingFile("nodemon-debug.mustache", getIndexDirectory(), "nodemon-debug.json"));
        supportingFiles.add(new SupportingFile("nodemon.mustache", getIndexDirectory(), "nodemon.json"));
